...
class ServiceContainer:
                ...
                if ontology_main[0] == type_skill:
                    ...
                    for skillName in data["ResumeParserData"]["SegregatedSkill"]:
                        ...
                        if len(ontology) == 3:
                            ...
                            skill_self = {
                                "name": skillName["FormattedName"],
                                "id": child_main["id"],
                                "value": "1",
                                "enabled": False,
                                "shortName": short_name,
                                "fill": "",
                                "grandParent": type_skill,
                                "parent": ontology_main[1],
                            }

                            if (
                                ontology[1] == ontology_main[1]
                                and skillName["FormattedName"] not in skills_array
                            ):
    ...
    def timeline_parse(self, data):
        ...
        for study in data["ResumeParserData"]["SegregatedQualification"]:
            event = {
                "period": study["FormattedDegreePeriod"],
